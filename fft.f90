...
!
  ...
  real*8 cc(in1,l1,ido,2)
  real*8 ch(in2,l1,2,ido)
  real*8 chold1
  real*8 chold2
  integer ( kind = 4 ) i
  integer ( kind = 4 ) k
...
!
  ...
  real*8 cc(in1,l1,ido,3)
  real*8 ch(in2,l1,3,ido)
  real*8 ci2
  real*8 ci3
  real*8 cr2
  real*8 cr3
  ...
  integer ( kind = 4 ) k
  integer ( kind = 4 ) na
  real*8, parameter :: taui =  0.866025403784439E+00
  real*8, parameter :: taur = -0.5E+00
  real*8 ti2
  real*8 tr2
  real*8 wa(ido,2,2)
...
!
  ...
  real*8 cc(in1,l1,ido,4)
  real*8 ch(in2,l1,4,ido)
  real*8 ci2
  real*8 ci3
  real*8 ci4
  real*8 cr2
...
!
  ...
  real*8 cc(in1,l1,ido,5)
  real*8 ch(in2,l1,5,ido)
  real*8 chold1
  real*8 chold2
  real*8 ci2
  real*8 ci3
  ...
  real*8 ti4
  real*8 ti5
  real*8, parameter :: ti11 =  0.9510565162951536E+00
  real*8, parameter :: ti12 =  0.5877852522924731E+00
  real*8 tr2
  real*8 tr3
  real*8 tr4
  real*8 tr5
  real*8, parameter :: tr11 =  0.3090169943749474E+00
  real*8, parameter :: tr12 = -0.8090169943749474E+00
  real*8 wa(ido,4,2)
...
!
  ...
  real*8 cc(in1,l1,ip,ido)
  real*8 cc1(in1,lid,ip)
  real*8 ch(in2,l1,ido,ip)
  real*8 ch1(in2,lid,ip)
  real*8 chold1
  real*8 chold2
  integer ( kind = 4 ) i
  integer ( kind = 4 ) idlj
...
!
!    Input, real*8 WSAVE(LENSAV).  WSAVE's contents must be 
...
!    LENSAV must be at least 2*N + INT(LOG(REAL(N))) + 4.
!
!    Output, real*8 WSAVE(LENSAV), containing the prime factors 
...
!    + INT(LOG(REAL(M))) + 8.
!
!    Output, real*8 WSAVE(LENSAV), contains the prime factors of L 
...
!
!    Input/output, real*8 R(LENR); on input, containing the sequence 
...
!    LENSAV must be at least 2*N + INT(LOG(REAL(N))) + 4.
!
!    Output, real*8 WSAVE(LENSAV), containing the prime factors of N
...
!
!    Input/output, real*8 R(LENR), array containing LOT sequences, 
...
!    LENSAV must be at least 2*N + INT(LOG(REAL(N))) + 4.
!
!    Output, real*8 WSAVE(LENSAV), containing the prime factors of 
...
!    in array R, of two consecutive elements within the sequence.
!
!    Input/output, real*8 R(LENR), containing the sequence to 
!     be transformed.
!
!    Input, integer ( kind = 4 ) LENR, the dimension of the R array.  
!    LENR must be at least INC*(N-1)+ 1.
...
!
  ...
  real*8 cc(in1,ido,2,l1)
  real*8 ch(in2,ido,l1,2)
  integer ( kind = 4 ) i
  integer ( kind = 4 ) ic
  integer ( kind = 4 ) idp2
  integer ( kind = 4 ) im1
...
!
  ...
  real*8 arg
  real*8 cc(in1,ido,3,l1)
  real*8 ch(in2,ido,l1,3)
  integer ( kind = 4 ) i
  integer ( kind = 4 ) ic
  integer ( kind = 4 ) idp2
  integer ( kind = 4 ) im1
...
!
  ...
  real*8 cc(in1,ido,4,l1)
  real*8 ch(in2,ido,l1,4)
  integer ( kind = 4 ) i
  integer ( kind = 4 ) ic
  integer ( kind = 4 ) idp2
  integer ( kind = 4 ) im1
...
!
  ...
  real*8 arg
  real*8 cc(in1,ido,5,l1)
  real*8 ch(in2,ido,l1,5)
  integer ( kind = 4 ) i
  integer ( kind = 4 ) ic
  integer ( kind = 4 ) idp2
  integer ( kind = 4 ) im1
...
!
  ...
  real*8 ar2h
  real*8 arg
  real*8 c1(in1,ido,l1,ip)
  real*8 c2(in1,idl1,ip)
  real*8 cc(in1,ido,ip,l1)
  real*8 ch(in2,ido,l1,ip)
  real*8 ch2(in2,idl1,ip)
  real*8 dc2
  real*8 dcp
  real*8 ds2
  real*8 dsp
...
!
  ...
  real*8 cc(in1,ido,l1,2)
  real*8 ch(in2,ido,2,l1)
  integer ( kind = 4 ) i
  integer ( kind = 4 ) ic
  integer ( kind = 4 ) idp2
  integer ( kind = 4 ) im1
...
!
  ...
  real*8 arg
  real*8 cc(in1,ido,l1,3)
  real*8 ch(in2,ido,3,l1)
  integer ( kind = 4 ) i
  integer ( kind = 4 ) ic
  integer ( kind = 4 ) idp2
  integer ( kind = 4 ) im1
...
!
  ...
  real*8 cc(in1,ido,l1,4)
  real*8 ch(in2,ido,4,l1)
  real*8 hsqt2
  integer ( kind = 4 ) i
  integer ( kind = 4 ) ic
  integer ( kind = 4 ) idp2
...
!
  ...
  real*8 arg
  real*8 cc(in1,ido,l1,5)
  real*8 ch(in2,ido,5,l1)
  integer ( kind = 4 ) i
  integer ( kind = 4 ) ic
  integer ( kind = 4 ) idp2
  integer ( kind = 4 ) im1
...
!
!    Output, real*8 WA(N), trigonometric information.
!
!    Output, real*8 FAC(15), factorization information.  FAC(1) is 
...
!
!    Output, real*8 FAC(*), a list of factors of N.
!
  implicit none
...
!    in array R, of two consecutive elements within the sequence. 
!
!    Input/output, real*8 R(LENR), on input, the data to be 
...
!
!    Input/output, real*8 R(LENR), on input, contains the sequence 
!    to be transformed, and on output, the transformed data.
!
!    Input, integer ( kind = 4 ) LENR, the dimension of the R array.  
!    LENR must be at least INC*(N-1) + 1.
...
!    is most efficient when M is a product of small primes.
!
!    Input/output, real*8 R(LDIM,M), the real array of two 
...
!    + INT(LOG(REAL(M))) + 8.
!
!    Workspace, real*8 WORK(LENWRK).  WORK provides workspace, and 
...
!    + INT(LOG(REAL(M))) + 8. 
!
!    Workspace, real*8 WORK(LENWRK), provides workspace, and its 
...
!    Output, real*8 WA(N), trigonometric information.
!
!    Output, real*8 FAC(15), factorization information.  
...
!    array R, of two consecutive elements within the same sequence.
!
!    Input/output, real*8 R(LENR), real array containing LOT 
...
!    LENSAV must be at least N + INT(LOG(REAL(N))) + 4.
!
!    Output, real*8 WSAVE(LENSAV), work array containing the prime 
...
!    array R, of two consecutive elements within the sequence.
!
!    Input/output, real*8 R(LENR), on input, the sequence to be 
...
!
  ...
  real*8 wsave(lensav)
      ...
      if (lensav < 2*n + int(log( real ( n, kind = 4 ) ) &
        /log( 2.0E+00 )) +4) then
        ier = 2
...
!    array R, of two consecutive elements within the same sequence.
!
!    Input/output, real*8 R(LENR), containing LOT sequences, each 
